...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(all_sites, names='Launch Site', values='class', title='Success Count for All Sites')
    else:
        filtered_site = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.pie(filtered_site, names='class', title=f'Success Count for {entered_site}')
...
def get_scatter_plot(entered_site, payload_range):
    if entered_site == 'ALL':
        ...
        filtered_site = spacex_df[(spacex_df['Launch Site'] == entered_site) & 
                                  ...
                                  (spacex_df['Payload Mass (kg)'] <= payload_range[1])]
        fig = px.scatter(filtered_site, x='Payload Mass (kg)', y='class', color='Booster Version Category')
